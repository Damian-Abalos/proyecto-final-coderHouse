...
const mensajeria = require('../../utils/mensajes')

const UsuariosDAOFactory = require("../DAOs/Factory/UsuarioDAOFactory.js")
const DAOuser = UsuariosDAOFactory.get()
...
router.post('/register', async (req, res) => {
    ...
    let newUsuario = null
    newUsuario = await DAOuser.listar(email)
    if (newUsuario) {
        ...
        try {
            const graba = await DAOuser.guardar(usuarioData)
        } catch (error) {
